...
function displayMovieDetails(details) {
  ...
  if (details.Type === 'movie') {
    ...
    videoLink = `https://www.2embed.to/embed/imdb/tv?id=${movieId}&s=1&e=1`;
  } else {
  ...
  function updateVideoLink(movieId, selectedSeason, selectedEpisode) {
    ...
    videoLink = `https://www.2embed.to/embed/imdb/tv?id=${movieId}&s=${selectedSeason}&e=${selectedEpisode}`;
  ...
  movies.forEach((movie) => {
    ...
    movieListItem.innerHTML = `
      ...
      <div class="movie-details">
        ...
        <button class="btn btn-secondary view-details" data-imdb-id="${movie.imdbID}">View Details</button>
      </div>
    `;
